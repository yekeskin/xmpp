...
do_get_name({teknorota_profile_avatar, _}) ->
    <<"avatar">>;
do_get_name({teknorota_profile_el,
             _,
             _,
             _,
             _,
...
do_get_ns({teknorota_profile_avatar, _}) ->
    <<"teknorota:xmpp:profile">>;
do_get_ns({teknorota_profile_el,
           _,
           _,
           _,
           _,
...
decode_teknorota_profile_query(__TopXMLNS, __Opts,
    ...
    {Updated, Get, Set, Existing, Last_seen} =
        decode_teknorota_profile_query_els(__TopXMLNS,
                                           __Opts,
                                           _els,
                                           [],
                                           [],
...
'encode_teknorota_profile_query_$get'([Get | _els],
                                      __TopXMLNS, _acc) ->
    'encode_teknorota_profile_query_$get'(_els,
                                          __TopXMLNS,
...
'encode_teknorota_profile_query_$set'([Set | _els],
                                      __TopXMLNS, _acc) ->
    'encode_teknorota_profile_query_$set'(_els,
                                          __TopXMLNS,
...
decode_teknorota_profile_el(__TopXMLNS, __Opts,
    ...
    {Avatar, Status, Lastupdated, Name, Hash, Key} =
        decode_teknorota_profile_el_els(__TopXMLNS,
                                        __Opts,
                                        _els,
                                        [],
                                        [],
...
decode_teknorota_profile_el_els(__TopXMLNS, __Opts, [],
                                Avatar, Status, Lastupdated, Name, Hash, Key) ->
    {lists:reverse(Avatar),
     lists:reverse(Status),
     lists:reverse(Lastupdated),
     lists:reverse(Name),
     lists:reverse(Hash),
     lists:reverse(Key)};
decode_teknorota_profile_el_els(__TopXMLNS, __Opts,
...
encode_teknorota_profile_el({teknorota_profile_el,
                             Jid,
                             Name,
                             Avatar,
                             Key,
...
'encode_teknorota_profile_el_$avatar'([Avatar | _els],
                                      __TopXMLNS, _acc) ->
    'encode_teknorota_profile_el_$avatar'(_els,
                                          __TopXMLNS,
...
'encode_teknorota_profile_el_$status'([Status | _els],
                                      __TopXMLNS, _acc) ->
    'encode_teknorota_profile_el_$status'(_els,
                                          __TopXMLNS,
...
'encode_teknorota_profile_el_$name'([Name | _els],
                                    __TopXMLNS, _acc) ->
    'encode_teknorota_profile_el_$name'(_els,
                                        __TopXMLNS,
...
'encode_teknorota_profile_el_$hash'([Hash | _els],
                                    __TopXMLNS, _acc) ->
    'encode_teknorota_profile_el_$hash'(_els,
                                        __TopXMLNS,
...
'encode_teknorota_profile_el_$key'([Key | _els],
                                   __TopXMLNS, _acc) ->
    'encode_teknorota_profile_el_$key'(_els,
                                       __TopXMLNS,
...
decode_teknorota_profile_set(__TopXMLNS, __Opts,
    ...
    {Avatar, Status, Name, Hash, Key} =
        decode_teknorota_profile_set_els(__TopXMLNS,
                                         __Opts,
                                         _els,
                                         [],
                                         [],
...
'encode_teknorota_profile_set_$avatar'([Avatar | _els],
                                       __TopXMLNS, _acc) ->
    'encode_teknorota_profile_set_$avatar'(_els,
                                           __TopXMLNS,
                                           [encode_teknorota_profile_avatar(Avatar,
                                                                            __TopXMLNS)
                                            | _acc]).
...
'encode_teknorota_profile_set_$status'([Status | _els],
                                       __TopXMLNS, _acc) ->
    'encode_teknorota_profile_set_$status'(_els,
                                           __TopXMLNS,
                                           [encode_teknorota_profile_status(Status,
                                                                            __TopXMLNS)
                                            | _acc]).
...
'encode_teknorota_profile_set_$name'([Name | _els],
                                     __TopXMLNS, _acc) ->
    'encode_teknorota_profile_set_$name'(_els,
                                         __TopXMLNS,
                                         [encode_teknorota_profile_name(Name,
                                                                        __TopXMLNS)
                                          | _acc]).
...
'encode_teknorota_profile_set_$hash'([Hash | _els],
                                     __TopXMLNS, _acc) ->
    'encode_teknorota_profile_set_$hash'(_els,
                                         __TopXMLNS,
                                         [encode_teknorota_profile_hash(Hash,
                                                                        __TopXMLNS)
                                          | _acc]).
...
'encode_teknorota_profile_set_$key'([Key | _els],
                                    __TopXMLNS, _acc) ->
    'encode_teknorota_profile_set_$key'(_els,
                                        __TopXMLNS,
                                        [encode_teknorota_profile_key(Key,
                                                                      __TopXMLNS)
                                         | _acc]).
...
decode_teknorota_profile_status_els(__TopXMLNS, __Opts,
    ...
    decode_teknorota_profile_status_els(__TopXMLNS,
                                        __Opts,
                                        _els,
                                        <<Cdata/binary, _data/binary>>);
decode_teknorota_profile_status_els(__TopXMLNS, __Opts,
...
decode_teknorota_profile_hash_els(__TopXMLNS, __Opts,
                                  [{xmlcdata, _data} | _els], Cdata) ->
    decode_teknorota_profile_hash_els(__TopXMLNS,
                                      __Opts,
                                      _els,
                                      <<Cdata/binary, _data/binary>>);
decode_teknorota_profile_hash_els(__TopXMLNS, __Opts,
...
decode_teknorota_profile_key_els(__TopXMLNS, __Opts,
                                 [{xmlcdata, _data} | _els], Cdata) ->
    decode_teknorota_profile_key_els(__TopXMLNS,
                                     __Opts,
                                     _els,
                                     <<Cdata/binary, _data/binary>>);
decode_teknorota_profile_key_els(__TopXMLNS, __Opts,
...
decode_teknorota_profile_avatar_els(__TopXMLNS, __Opts,
                                    [{xmlcdata, _data} | _els], Cdata) ->
    decode_teknorota_profile_avatar_els(__TopXMLNS,
                                        __Opts,
                                        _els,
                                        <<Cdata/binary, _data/binary>>);
decode_teknorota_profile_avatar_els(__TopXMLNS, __Opts,
...
decode_teknorota_profile_name_els(__TopXMLNS, __Opts,
                                  [{xmlcdata, _data} | _els], Cdata) ->
    decode_teknorota_profile_name_els(__TopXMLNS,
                                      __Opts,
                                      _els,
                                      <<Cdata/binary, _data/binary>>);
decode_teknorota_profile_name_els(__TopXMLNS, __Opts,
